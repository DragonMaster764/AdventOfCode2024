...
vector<string> allOPCombos(vector<string> ops, int sizeArray);
long long allCombos(const vector<int>& rowOfNums, long long total);
long long vectorOperation(long long fNum, long long sNum, char op);
...
long long allCombos(const vector<int>& rowOfNums, long long total)
{
	...
	vector<string> opCombos = allOPCombos(ops, rowOfNums.size());
